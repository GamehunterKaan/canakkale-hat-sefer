...
for (const [key, value] of Object.entries({
  o: '40.15000,26.41000', d: '40.16000,26.42000', m: 'depart', t: '10:00',
  l1: '1|0|101|102',
...
const context = vm.createContext({
  ...
  _schedFrame: n => n, _syncPlanModeButtons() {},
  ...
  _walkMatrix() {},
  buildTripFromSpec(_spec, opts) { rebuilt++; assert.equal(opts.dayData, schedule.routes); return { trip: true }; },
  ...
  _suppressAutoPlan: false, arriveActive: () => false,
  Date,
});
...
console.log('trip link cold-load order: passed');
